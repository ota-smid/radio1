...
def my_event_callback_function(pin):
  global station_num
  print pin
  # pin 11 - stisknuto tlacitko pro start prehravani
  if (pin == 11):
    if (station_num == 0): # rozsvitim ledku a zapnout
      GPIO.output(16, False)
      GPIO.output(18, True)
      GPIO.output(22, True)
      station_num = 1
      retvalue = os.system("sudo /home/pi/pifm/pifmplay /home/pi/MyMusic/ 98.0 &")
      print "poustim z voleje jednicku"
      return
  ...
  # pin 13 - stisknuto tlacitko pro volbu stanice
  if (pin == 13):
